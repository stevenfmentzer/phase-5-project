  ...
  return (
    <div className="dashboard">
      <div className="welcome-container">
        ...
        <p className="welcome-message">It's been a while since you have reached out to Mellissa Cunningham.</p>
        <p className="welcome-message">Gina Jones and Cathty Mosley's birthdays are coming up.</p>
